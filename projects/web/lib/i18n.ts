...
const dict = {
  ...
  'dov.publishingTrend': {
    en: 'Publishing trend',
    rw: 'Uko gutangaza bigenda',
    fr: 'Tendance de publication',
  },
  'dov.last14Days': { en: 'Last 14 days', rw: 'Iminsi 14 ishize', fr: '14 derniers jours' },
  'dov.pipelineBreakdown': {
    en: 'Pipeline breakdown',
    rw: 'Uko inzira igabanijwe',
    fr: 'Répartition du flux',
  },
  'dov.topDesks': { en: 'Top desks', rw: 'Ibyiciro bikomeye', fr: 'Rubriques principales' },
  'dov.mediaLibrary': { en: 'Media library', rw: 'Ububiko bw’amakuru', fr: 'Médiathèque' },
  'dov.engagement': { en: 'Engagement', rw: 'Ukwitabira', fr: 'Engagement' },
  'dov.views': { en: 'Views', rw: 'Abarebye', fr: 'Vues' },
  'dov.likes': { en: 'Likes', rw: 'Bakunze', fr: 'J’aime' },
  'dov.comments': { en: 'Comments', rw: 'Ibitekerezo', fr: 'Commentaires' },
  'dov.shares': { en: 'Shares', rw: 'Basangije', fr: 'Partages' },
  'dov.episodes': { en: 'Episodes', rw: 'Ibice', fr: 'Épisodes' },
  'dov.noData': { en: 'No data yet', rw: 'Nta makuru arahari', fr: 'Pas encore de données' },
  'dov.recentComments': {
    en: 'Latest comments',
    rw: 'Ibitekerezo bigezweho',
    fr: 'Derniers commentaires',
  },
  'dov.newMembers': { en: 'New members', rw: 'Abanyamuryango bashya', fr: 'Nouveaux membres' },
