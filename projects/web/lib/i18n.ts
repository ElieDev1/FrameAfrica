...
const dict = {
  ...
  'daud.locked': { en: 'Account locked', rw: 'Konti yafunzwe', fr: 'Compte verrouillé' },
  'daud.unlocked': { en: 'Account unlocked', rw: 'Konti yafunguwe', fr: 'Compte déverrouillé' },
  'daud.passwordReset': {
    en: 'Password reset',
    rw: 'Ijambobanga ryahinduwe',
    fr: 'Mot de passe réinitialisé',
  },
  'daud.subChanged': {
    en: 'Subscription changed',
    rw: 'Iyandikisha ryahinduwe',
    fr: 'Abonnement modifié',
  },
  'daud.total': { en: 'Total events', rw: 'Ibikorwa byose', fr: 'Événements' },
  'daud.securityEvents': {
    en: 'Security events',
    rw: 'Ibijyanye n’umutekano',
    fr: 'Événements de sécurité',
  },
  'daud.last24h': { en: 'Last 24h', rw: 'Amasaha 24 ashize', fr: 'Dernières 24 h' },
  'daud.actors': { en: 'Actors', rw: 'Abakoze', fr: 'Acteurs' },
  'daud.catAll': { en: 'All', rw: 'Byose', fr: 'Tout' },
  'daud.catSecurity': { en: 'Security', rw: 'Umutekano', fr: 'Sécurité' },
  'daud.catUsers': { en: 'Users', rw: 'Abakoresha', fr: 'Utilisateurs' },
  'daud.catContent': { en: 'Content', rw: 'Ibikubiyemo', fr: 'Contenu' },
  'daud.catOther': { en: 'Other', rw: 'Ibindi', fr: 'Autre' },
  'daud.details': { en: 'Details', rw: 'Ibisobanuro', fr: 'Détails' },
  'daud.noMeta': { en: 'No extra details', rw: 'Nta bindi bisobanuro', fr: 'Aucun détail' },
  ...
  'ddf.noImage': { en: 'No image yet', rw: 'Nta foto irahari', fr: 'Aucune image' },
  'ddf.removeImage': { en: 'Remove image', rw: 'Kura ifoto', fr: 'Retirer l’image' },
  'ddf.premiumHint': {
    en: 'Only subscribers can read the full story.',
    rw: 'Abiyandikishije gusa nibo basoma inkuru yose.',
    fr: 'Seuls les abonnés lisent l’article complet.',
  },
  'ddf.selected': { en: 'selected', rw: 'byatoranyijwe', fr: 'sélectionné(s)' },
  'ddf.unsaved': { en: 'Not saved yet', rw: 'Ntibirabikwa', fr: 'Non enregistré' },
  ...
  'dmg.copied': { en: 'Copied', rw: 'Byakoporowe', fr: 'Copié' },
  'dmg.anyFile': {
    en: 'File — image, video or audio',
    rw: 'Dosiye — ifoto, amashusho cyangwa ijwi',
    fr: 'Fichier — image, vidéo ou audio',
  },
  'dmg.sizeHint': {
    en: 'Images ≤ 8 MB · video/audio ≤ 200 MB',
    rw: 'Amafoto ≤ 8 MB · amashusho/ijwi ≤ 200 MB',
    fr: 'Images ≤ 8 Mo · vidéo/audio ≤ 200 Mo',
  },
  'dmg.search': {
    en: 'Search files…',
    rw: 'Shakisha dosiye…',
  ...
  'dmg.empty': { en: 'No files here yet.', rw: 'Nta dosiye ziri hano.', fr: 'Aucun fichier ici.' },
  'dmg.files': { en: 'files', rw: 'dosiye', fr: 'fichiers' },
  'dmg.allFiles': { en: 'All files', rw: 'Dosiye zose', fr: 'Tous les fichiers' },
  'dmg.unfiled': { en: 'Unfiled', rw: 'Bitarashyirwa mu bubiko', fr: 'Non classé' },
  'dmg.albums': { en: 'Albums', rw: 'Ububiko', fr: 'Albums' },
  'dmg.newAlbum': { en: 'New album', rw: 'Ububiko bushya', fr: 'Nouvel album' },
  'dmg.albumName': { en: 'Album name (event)', rw: 'Izina ry’ububiko', fr: 'Nom de l’album' },
  'dmg.eventDate': { en: 'Event date', rw: 'Itariki y’igikorwa', fr: 'Date de l’événement' },
  'dmg.createAlbum': { en: 'Create album', rw: 'Kora ububiko', fr: 'Créer l’album' },
  'dmg.deleteAlbum': { en: 'Delete album', rw: 'Siba ububiko', fr: 'Supprimer l’album' },
  'dmg.deleteAlbumConfirm': {
    en: 'Delete this album? Its files are kept — they simply become Unfiled.',
    rw: 'Gusiba ubu bubiko? Dosiye zizagumaho — zizajya mu bitarashyizwe mu bubiko.',
    fr: 'Supprimer cet album ? Les fichiers sont conservés — ils deviennent simplement non classés.',
  },
  'dmg.moveTo': { en: 'Move to album', rw: 'Imura ujye mu bubiko', fr: 'Déplacer vers l’album' },
  'dmg.albumHint': {
    en: 'Group each event’s photos and clips into an album so they can be found again. Deleting an album never deletes its files.',
    rw: 'Shyira amafoto n’amashusho by’igikorwa mu bubiko kugira ngo bizongere biboneke. Gusiba ububiko ntibisiba dosiye.',
    fr: 'Regroupez les photos et clips d’un événement dans un album pour les retrouver. Supprimer un album ne supprime jamais ses fichiers.',
  },
  'dmg.dropHere': {
    en: 'Drop files here, or click to browse',
    rw: 'Shyira dosiye hano, cyangwa kanda uzishakishe',
    fr: 'Déposez des fichiers ici, ou cliquez pour parcourir',
  },
  'dmg.filesSelected': {
    en: 'files selected',
    rw: 'dosiye zatoranyijwe',
    fr: 'fichiers sélectionnés',
  },
  'dmg.clearAll': { en: 'Clear all', rw: 'Siba byose', fr: 'Tout effacer' },
  'dmg.removeFile': { en: 'Remove file', rw: 'Kura dosiye', fr: 'Retirer le fichier' },
  'dmg.uploadedOk': { en: 'uploaded ✓', rw: 'byoherejwe ✓', fr: 'téléversé(s) ✓' },
  'dmg.altBatchHint': {
    en: 'Alt text is set per file after upload',
    rw: 'Alt yandikwa kuri buri dosiye nyuma yo kohereza',
    fr: 'Le texte alt se définit par fichier après le téléversement',
  },
  'dmg.totalFiles': { en: 'Total files', rw: 'Dosiye zose', fr: 'Fichiers' },
  'dmg.kindAll': { en: 'All', rw: 'Byose', fr: 'Tout' },
  'dmg.kindImages': { en: 'Images', rw: 'Amafoto', fr: 'Images' },
  'dmg.kindVideo': { en: 'Video', rw: 'Amashusho', fr: 'Vidéo' },
  'dmg.kindAudio': { en: 'Audio', rw: 'Amajwi', fr: 'Audio' },
