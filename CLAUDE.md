...
14. `documents/13-Product-Plan.md` — **how we build now: roles, real content model + taxonomy, complete workspaces, Definition of Done**
15. `documents/adr/` — architecture decisions
